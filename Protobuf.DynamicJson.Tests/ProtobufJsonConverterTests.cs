        ...
        {
            {
                ...
                "{\"masterSwitches\":{\"flags\":\"69Q=\"},\"deviceParameters\":{\"parameters\":[{\"key\":\"PARAMETER_KEY_AssetRecoveryOnlyInTrip\",\"valueBool\":false},{\"key\":\"PARAMETER_KEY_AssetRecoverySleepInterval\",\"valueBytes\":\"GG0=\"}]}}"
            },
            {
                "Mappings",
                "syntax = \"proto3\";\n\noption csharp_namespace = \"Contoso.Protobuf\";\noption go_package = \"git.contoso.com/dev/GatewayGoProto-golang/configuration/iox\";\n\nmessage UIntPoints {\n    repeated uint32 input_values = 1;\n    repeated uint32 output_values = 2;\n}\n\nenum DigitalAux {\n    DIGITAL_AUX_1 = 0;\n    DIGITAL_AUX_2 = 1;\n    DIGITAL_AUX_3 = 2;\n    DIGITAL_AUX_4 = 3;\n    DIGITAL_AUX_5 = 4;\n    DIGITAL_AUX_6 = 5;\n    DIGITAL_AUX_7 = 6;\n    DIGITAL_AUX_8 = 7;\n}\n\nmessage Input {\n    oneof input {\n        DigitalAux aux = 1;\n        uint32 status_id = 2;\n    }\n}\n\nmessage Output {\n    oneof output {\n        uint32 status_id = 1;\n    }\n}\n\nmessage Transform {\n    oneof transform {\n        UIntPoints uint_points = 1;\n    }\n}\n\nmessage Mapping {\n    Input input = 1;\n    Output output = 2;\n    Transform transform = 3;\n}\n\nmessage Mappings {\n    repeated Mapping mapping = 1;\n}",
                "{\"mapping\":[{\"input\":{\"statusId\":42},\"output\":{\"statusId\":17},\"transform\":{\"uintPoints\":{\"inputValues\":[100,200],\"outputValues\":[150,250]}}},{\"input\":{\"aux\":\"DIGITAL_AUX_3\"},\"output\":{\"statusId\":33},\"transform\":{\"uintPoints\":{\"inputValues\":[1,2,3],\"outputValues\":[4,5,6]}}}]}"
            },
            {
                "Mappings_old",
                ...
                "{\"mapping\":[{\"input\":{\"statusId\":79},\"output\":{\"statusId\":61},\"transform\":{\"floatPoints\":{\"inputValues\":[217,88],\"outputValues\":[225,107]}}},{\"input\":{\"aux\":\"DIGITAL_AUX_1\"},\"output\":{\"statusId\":111},\"transform\":{\"floatPoints\":{\"inputValues\":[121,65],\"outputValues\":[108,134]}}}]}"
            },
            {
            ...
            },
            {
                ...
                "{\n  \"tripId\": 5678,\n  \"startTime\": 1653100000000,\n  \"endTime\": 1653103600000,\n  \"distanceKm\": 25.7\n}"
            },
            {
                "test.LocationEvent",
            ...
            },
            {
                ...
                "{\n  \"doubleField\": 123.456,\n  \"floatField\": 78.9,\n  \"int32Field\": 12345,\n  \"int64Field\": 9876543210,\n  \"uint32Field\": 4294967295,\n  \"uint64Field\": 9007199254740991,\n  \"sint32Field\": -123,\n  \"sint64Field\": -9876543210,\n  \"fixed32Field\": 1000,\n  \"fixed64Field\": 1000000,\n  \"sfixed32Field\": -1000,\n  \"sfixed64Field\": -1000000,\n  \"boolField\": true,\n  \"stringField\": \"hello world\",\n  \"bytesField\": \"SGVsbG8gV29ybGQ=\",\n  \"enumField\": \"COMPLETED\",\n  \"repeatedInt32Field\": [1, 2, 3, 4, 5],\n  \"repeatedStringField\": [\"a\", \"b\", \"c\"],\n  \"stringToIntMap\": {\n    \"one\": 1,\n    \"two\": 2\n  },\n  \"nestedMessage\": {\n    \"nestedField\": \"nested value\"\n  },\n  \"repeatedNested\": [\n    { \"nestedField\": \"nested 1\" },\n    { \"nestedField\": \"nested 2\" }\n  ],\n  \"oneofString\": \"chosen oneof value\",\n  \"timestampField\": \"2022-04-15T17:20:00.123456789Z\",\n  \"durationField\": \"3600s\",\n  \"optionalStringField\": \"optional value\"\n}"
            },
            {
                "test.TreeNode",
